...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    <% Html.BeginForm("Edit", "Role", FormMethod.Post, new { @class = "form-horizontal" }); %>
        ...
        <div class="controls">
            <div class="btn-group">
                ...
                <button type="submit" class="btn btn-primary" value="Edit">
                    Rolle speichern</button>
            </div>
            <%: Html.ActionLink("Rolle " + Model.Name + " löschen", "Delete", "Role", new { id = Model.RId }, new { @class = "btn btn-danger" })%>
        </div>
    </div>
    <% Html.EndForm(); %>

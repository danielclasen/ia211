...
namespace VersionR.Helpers.BootstrapMvcHelpers.DropDown
{
    /// <summary>
    ...
    public class DropDownHelper : IBootstrapComponent
    {
        ...
        /// <returns></returns>
        public DropDownHelper(HtmlHelper helper, string name, IEnumerable<MenuItem> selectList, string optionLabel,

...
using VersionR.Helpers.BootstrapMvcHelpers.Badge;
using VersionR.Helpers.BootstrapMvcHelpers.Breadcrumb;
using VersionR.Helpers.BootstrapMvcHelpers.Button;
using VersionR.Helpers.BootstrapMvcHelpers.DropDown;
using VersionR.Helpers.BootstrapMvcHelpers.Enums;
using VersionR.Helpers.BootstrapMvcHelpers.Label;
using VersionR.Helpers.BootstrapMvcHelpers.NavBar;
using VersionR.Helpers.BootstrapMvcHelpers.Shared;
using VersionR.Helpers.BootstrapMvcHelpers.Strategies;

namespace VersionR.Helpers.BootstrapMvcHelpers
{
    /// <summary>
    ...
    public static class Bootstrap
    {
        ...
        /// <param name="htmlAttributes">The HTML attributes.</param>
        /// <returns></returns>
        public static MvcHtmlString Button(this HtmlHelper helper, string text, string action, string controller = "",
                                           ButtonStatus status = ButtonStatus.Default, object htmlAttributes = null)
        {
            ButtonHelper button = new ButtonHelper(helper, GetStatusStrategy(status), text, action, controller, status,
                                                   htmlAttributes);
            return MvcHtmlString.Create(button.Render());
        }
        ...
        /// <param name="htmlAttributes">The HTML attributes.</param>
        /// <returns></returns>
        public static MvcHtmlString MenuDropDown(this HtmlHelper helper, string name, IEnumerable<MenuItem> selectList,
                                                 string optionLabel = null, object htmlAttributes = null)
        {
            ...
            return MvcHtmlString.Create(dropDownHelper.Render());
        }
        ...
        public static MenuItem MenuItem(this HtmlHelper helper, string text, string action, string controller = null,
                                        object htmlattributes = null)
        {
            return new MenuItem(helper, text, action, controller, htmlattributes);
        }
        ...
        private static IStatusStrategy GetStatusStrategy(ButtonStatus status)
        {
            ...
            switch (status)
            {
                ...
                case ButtonStatus.Primary:
                    strategy = new PrimaryStatusStrategy();
                    break;

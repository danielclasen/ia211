...
namespace VersionR.Helpers.BootstrapMvcHelpers.NavBar
{
    public class NavBarHelper : IBootstrapComponent
    {
        ...
        public NavBarHelper(HtmlHelper helper, IEnumerable<MenuItem> menuList, BrandPosition brandPosition,
                            NavBarDisplay displayType, NavBarPosition navbarPosition, object htmlAttributes)
        {
            this.helper = helper;

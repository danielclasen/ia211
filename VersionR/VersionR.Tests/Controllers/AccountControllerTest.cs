...
namespace VersionR.Tests.Controllers
{
    ...
    public class AccountControllerTest
    {
        ...
        public void ChangePassword_Post_ReturnsViewIfChangePasswordFails()
        {
            ...
            Assert.AreEqual("Das aktuelle Kennwort ist nicht korrekt, oder das Kennwort ist ungültig.", controller.ModelState[""].Errors[0].ErrorMessage);
        ...
        public void ChangePassword_Post_ReturnsViewIfModelStateIsInvalid()
        {
            ...
            controller.ModelState.AddModelError("", "Dummyfehlermeldung");
        ...
        public void LogOn_Post_ReturnsViewIfValidateUserFails()
        {
            ...
            ViewResult viewResult = (ViewResult)result;
            Assert.AreEqual(model, viewResult.ViewData.Model);
            Assert.AreEqual("Der angegebene Benutzername oder das angegebene Kennwort ist ungültig.", controller.ModelState[""].Errors[0].ErrorMessage);
        }
        ...
        public void Register_Post_ReturnsViewIfRegistrationFails()
        {
            ...
            ViewResult viewResult = (ViewResult)result;
            Assert.AreEqual(model, viewResult.ViewData.Model);
            Assert.AreEqual("Der Benutzername ist bereits vorhanden. Geben Sie einen anderen Benutzernamen ein.", controller.ModelState[""].Errors[0].ErrorMessage);
            Assert.AreEqual(10, viewResult.ViewData["PasswordLength"]);
        }
        ...
        private class MockFormsAuthenticationService : IFormsAuthenticationService
        {
            ...
            {
                // Vergewissern, dass die Argumente den Erwartungen entsprechen
        ...
        private class MockMembershipService : IMembershipService
        {
            ...
            public MembershipCreateStatus CreateUser(string userName, string password, string email)
            {
                ...
                // Vergewissern, dass die Werte den Erwartungen entsprechen
